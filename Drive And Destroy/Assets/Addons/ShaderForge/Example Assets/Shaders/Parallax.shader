    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_574 = UnpackNormal(tex2D(_AORGBHeightA,TRANSFORM_TEX(node_35, _AORGBHeightA)));
...
////// Specular:
                ...
                float3 node_577 = UnpackNormal(tex2D(_AORGBHeightA,TRANSFORM_TEX(node_110.rg, _AORGBHeightA)));
