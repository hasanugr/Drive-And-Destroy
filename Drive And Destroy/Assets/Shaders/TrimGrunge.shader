    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                UNITY_DEFINE_INSTANCED_PROP( float4, _BaseAlbedo)
                UNITY_DEFINE_INSTANCED_PROP( float, _BaseAlbedomultiply)
                UNITY_DEFINE_INSTANCED_PROP( float, _GrungeStrength)
                UNITY_DEFINE_INSTANCED_PROP( float4, _DirtAlbedo)
                UNITY_DEFINE_INSTANCED_PROP( float, _DirtAlbedoMultiply)
                UNITY_DEFINE_INSTANCED_PROP( float, _AOMultiplier)
                UNITY_DEFINE_INSTANCED_PROP( float, _BaseRoughness)
                UNITY_DEFINE_INSTANCED_PROP( float, _DirtRoughness)
                UNITY_DEFINE_INSTANCED_PROP( float, _GrungeLerpA)
                UNITY_DEFINE_INSTANCED_PROP( float, _GrungeLerpB)
                UNITY_DEFINE_INSTANCED_PROP( float, _BaseMetallic)
                UNITY_DEFINE_INSTANCED_PROP( float, _DirtMetallic)
                UNITY_DEFINE_INSTANCED_PROP( float, _GrungeSelector)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _UV_1)
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 _UV_1_var = lerp( i.uv1, i.uv0, UNITY_ACCESS_INSTANCED_PROP( Props, _UV_1 ) );
...
///////// Gloss:
                float _BaseRoughness_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseRoughness );
                float _DirtRoughness_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DirtRoughness );
                float _GrungeLerpA_var = UNITY_ACCESS_INSTANCED_PROP( Props, _GrungeLerpA );
                float _GrungeLerpB_var = UNITY_ACCESS_INSTANCED_PROP( Props, _GrungeLerpB );
                float _GrungeStrength_var = UNITY_ACCESS_INSTANCED_PROP( Props, _GrungeStrength );
                float _GrungeSelector_var = UNITY_ACCESS_INSTANCED_PROP( Props, _GrungeSelector );
                float node_3832_if_leA = step(floor(_GrungeSelector_var),1.0);
                float node_3832_if_leB = step(1.0,floor(_GrungeSelector_var));
                ...
                float node_7487 = saturate(lerp(_GrungeLerpA_var,_GrungeLerpB_var,(_GrungeStrength_var*lerp((node_3832_if_leA*node_1936.b)+(node_3832_if_leB*node_1936.r),node_1936.g,node_3832_if_leA*node_3832_if_leB))).r);
                float gloss = 1.0 - lerp(_BaseRoughness_var,_DirtRoughness_var,node_7487); // Convert roughness to gloss
                float perceptualRoughness = lerp(_BaseRoughness_var,_DirtRoughness_var,node_7487);
...
////// Specular:
                ...
                float _DirtMetallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DirtMetallic );
                float3 specularColor = lerp(_BaseMetallic_var,_DirtMetallic_var,node_7487);
                float specularMonochrome;
                float4 _BaseAlbedo_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseAlbedo );
                float _BaseAlbedomultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseAlbedomultiply );
                float4 _DirtAlbedo_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DirtAlbedo );
                float _DirtAlbedoMultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DirtAlbedoMultiply );
                float3 node_5202 = lerp((_BaseAlbedo_var.rgb*_BaseAlbedomultiply_var),(_DirtAlbedo_var.rgb*_DirtAlbedoMultiply_var),node_7487);
                float _AOMultiplier_var = UNITY_ACCESS_INSTANCED_PROP( Props, _AOMultiplier );
                float3 diffuseColor = saturate(lerp(node_5202,(_NormalsAO_var.b*node_5202),_AOMultiplier_var)); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _NormalsAO_var = tex2D(_NormalsAO,TRANSFORM_TEX(_UV_1_var, _NormalsAO));
                float _AOMultiplier_var = UNITY_ACCESS_INSTANCED_PROP( Props, _AOMultiplier );
                float3 diffColor = saturate(lerp(node_5202,(_NormalsAO_var.b*node_5202),_AOMultiplier_var));
                float specularMonochrome;
                float3 specColor;
                float _BaseMetallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseMetallic );
                float _DirtMetallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DirtMetallic );
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, lerp(_BaseMetallic_var,_DirtMetallic_var,node_7487), specColor, specularMonochrome );
                float _BaseRoughness_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseRoughness );
                float _DirtRoughness_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DirtRoughness );
                float roughness = lerp(_BaseRoughness_var,_DirtRoughness_var,node_7487);
