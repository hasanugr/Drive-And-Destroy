    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( fixed, _IsPart)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _DecalMultiply)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _SecondaryMultiply)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _PrimaryMultiply)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _RoughnessLerpA)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _RoughnessLerpB)
                UNITY_DEFINE_INSTANCED_PROP( float4, _EdgeGlowColor)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _EdgeGlowContrast)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _EdgeGlowPulseSpeed)
                UNITY_DEFINE_INSTANCED_PROP( float, _EdgeGlowMultiply)
                UNITY_DEFINE_INSTANCED_PROP( float, _DisolveAmount)
                UNITY_DEFINE_INSTANCED_PROP( float4, _DisolveGlowColor)
                UNITY_DEFINE_INSTANCED_PROP( float, _DisolveColorMultiply)
                UNITY_DEFINE_INSTANCED_PROP( float, _EdgeGlowSelector)
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float _DisolveAmount_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DisolveAmount );
                float4 _DisolveMask_var = tex2D(_DisolveMask,TRANSFORM_TEX(i.uv0, _DisolveMask));
                float node_1538 = (((_DisolveAmount_var*1.4+-0.4)+_DisolveMask_var.r)*2.0+-1.0);
                clip(node_1538 - 0.5);
...
///////// Gloss:
                fixed _RoughnessLerpA_var = UNITY_ACCESS_INSTANCED_PROP( Props, _RoughnessLerpA );
                fixed _RoughnessLerpB_var = UNITY_ACCESS_INSTANCED_PROP( Props, _RoughnessLerpB );
                float4 _RMA_var = tex2D(_RMA,TRANSFORM_TEX(i.uv0, _RMA));
                float gloss = 1.0 - lerp(_RoughnessLerpA_var,_RoughnessLerpB_var,_RMA_var.r); // Convert roughness to gloss
                float perceptualRoughness = lerp(_RoughnessLerpA_var,_RoughnessLerpB_var,_RMA_var.r);
...
////// Specular:
                ...
                fixed _PrimaryMultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _PrimaryMultiply );
                float4 _SecondaryColor_var = UNITY_ACCESS_INSTANCED_PROP( Props, _SecondaryColor );
                fixed _SecondaryMultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _SecondaryMultiply );
                ...
                float _EdgeGlowSelector_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EdgeGlowSelector );
                float node_7295_if_leA = step(floor(_EdgeGlowSelector_var),1.0);
                float node_7295_if_leB = step(1.0,floor(_EdgeGlowSelector_var));
                float3 _IsPart_var = lerp( float3(_DecalMask_var.r,_DecalMask_var.g,_EdgeGlowMask_var.r), float3(_DecalMask_var.b,_DecalMask_var.a,lerp((node_7295_if_leA*_EdgeGlowMask_var.g)+(node_7295_if_leB*_EdgeGlowMask_var.a),_EdgeGlowMask_var.b,node_7295_if_leA*node_7295_if_leB)), UNITY_ACCESS_INSTANCED_PROP( Props, _IsPart ) );
                float3 node_4905 = _IsPart_var.rgb;
                float4 _DecalColor_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DecalColor );
                fixed _DecalMultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DecalMultiply );
                float4 _EdgeGlowColor_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EdgeGlowColor );
                fixed _EdgeGlowContrast_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EdgeGlowContrast );
                float _EdgeGlowMultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EdgeGlowMultiply );
                fixed _EdgeGlowPulseSpeed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EdgeGlowPulseSpeed );
                float4 node_519 = _Time;
                float _DisolveColorMultiply_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DisolveColorMultiply );
                float4 _DisolveGlowColor_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DisolveGlowColor );
                float3 diffuseColor = lerp(lerp(lerp(_MainTex_var.rgb,lerp(lerp(((_MainTex_var.rgb*_PrimaryColor_var.rgb)*_PrimaryMultiply_var),((_MainTex_var.rgb*_SecondaryColor_var.rgb)*_SecondaryMultiply_var),node_4905.r),(_DecalColor_var.rgb*_DecalMultiply_var),node_4905.g),_MainTex_var.a),(_EdgeGlowColor_var.rgb*lerp(_EdgeGlowContrast_var,(_EdgeGlowContrast_var+_EdgeGlowMultiply_var),(sin((_EdgeGlowPulseSpeed_var*node_519.g))*0.5+0.5))),node_4905.b),(_DisolveColorMultiply_var*_DisolveGlowColor_var.rgb),(1.0 - saturate((node_1538*2.0+-1.0)))); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _DisolveMask_var = tex2D(_DisolveMask,TRANSFORM_TEX(i.uv0, _DisolveMask));
                float node_1538 = (((_DisolveAmount_var*1.4+-0.4)+_DisolveMask_var.r)*2.0+-1.0);
                float3 diffColor = lerp(lerp(lerp(_MainTex_var.rgb,lerp(lerp(((_MainTex_var.rgb*_PrimaryColor_var.rgb)*_PrimaryMultiply_var),((_MainTex_var.rgb*_SecondaryColor_var.rgb)*_SecondaryMultiply_var),node_4905.r),(_DecalColor_var.rgb*_DecalMultiply_var),node_4905.g),_MainTex_var.a),(_EdgeGlowColor_var.rgb*lerp(_EdgeGlowContrast_var,(_EdgeGlowContrast_var+_EdgeGlowMultiply_var),(sin((_EdgeGlowPulseSpeed_var*node_519.g))*0.5+0.5))),node_4905.b),(_DisolveColorMultiply_var*_DisolveGlowColor_var.rgb),(1.0 - saturate((node_1538*2.0+-1.0))));
                float specularMonochrome;
                float3 specColor;
                float4 _RMA_var = tex2D(_RMA,TRANSFORM_TEX(i.uv0, _RMA));
                ...
                fixed _RoughnessLerpA_var = UNITY_ACCESS_INSTANCED_PROP( Props, _RoughnessLerpA );
                fixed _RoughnessLerpB_var = UNITY_ACCESS_INSTANCED_PROP( Props, _RoughnessLerpB );
                float roughness = lerp(_RoughnessLerpA_var,_RoughnessLerpB_var,_RMA_var.r);
