    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _RoughnessMacroScale)
                UNITY_DEFINE_INSTANCED_PROP( float, _MacroNoiseLerpLight)
                UNITY_DEFINE_INSTANCED_PROP( float, _MacroNoiseLerpDark)
                UNITY_DEFINE_INSTANCED_PROP( float, _EmissiveStrength)
                UNITY_DEFINE_INSTANCED_PROP( float, _AOAmount)
                UNITY_DEFINE_INSTANCED_PROP( float, _BaseRoughnessLerpDark)
                UNITY_DEFINE_INSTANCED_PROP( float, _BaseRoughnessLerpLight)
...
///////// Gloss:
                float _MacroNoiseLerpLight_var = UNITY_ACCESS_INSTANCED_PROP( Props, _MacroNoiseLerpLight );
                float _MacroNoiseLerpDark_var = UNITY_ACCESS_INSTANCED_PROP( Props, _MacroNoiseLerpDark );
                float3 node_4418 = pow(abs(i.normalDir),2.0);
                float _RoughnessMacroScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _RoughnessMacroScale );
                float2 node_606 = (float2(i.posWorld.g,i.posWorld.b)*_RoughnessMacroScale_var);
                float4 _node_7181 = tex2D(_RoughnessMacro,TRANSFORM_TEX(node_606, _RoughnessMacro));
                float2 node_9950 = (float2(i.posWorld.b,i.posWorld.r)*_RoughnessMacroScale_var);
                float4 _node_217 = tex2D(_RoughnessMacro,TRANSFORM_TEX(node_9950, _RoughnessMacro));
                float2 node_4784 = (float2(i.posWorld.r,i.posWorld.g)*_RoughnessMacroScale_var);
                float4 _node_4734 = tex2D(_RoughnessMacro,TRANSFORM_TEX(node_4784, _RoughnessMacro));
                float _BaseRoughnessLerpLight_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseRoughnessLerpLight );
                float _BaseRoughnessLerpDark_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseRoughnessLerpDark );
                float4 _RMA_var = tex2D(_RMA,TRANSFORM_TEX(i.uv0, _RMA));
                float gloss = 1.0 - saturate(saturate(( lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r) > 0.5 ? (1.0-(1.0-2.0*(lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r)-0.5))*(1.0-lerp(_MacroNoiseLerpLight_var,_MacroNoiseLerpDark_var,(node_4418.r*_node_7181.r + node_4418.g*_node_217.r + node_4418.b*_node_4734.r)))) : (2.0*lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r)*lerp(_MacroNoiseLerpLight_var,_MacroNoiseLerpDark_var,(node_4418.r*_node_7181.r + node_4418.g*_node_217.r + node_4418.b*_node_4734.r))) ))); // Convert roughness to gloss
                float perceptualRoughness = saturate(saturate(( lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r) > 0.5 ? (1.0-(1.0-2.0*(lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r)-0.5))*(1.0-lerp(_MacroNoiseLerpLight_var,_MacroNoiseLerpDark_var,(node_4418.r*_node_7181.r + node_4418.g*_node_217.r + node_4418.b*_node_4734.r)))) : (2.0*lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r)*lerp(_MacroNoiseLerpLight_var,_MacroNoiseLerpDark_var,(node_4418.r*_node_7181.r + node_4418.g*_node_217.r + node_4418.b*_node_4734.r))) )));
...
////// Specular:
                ...
                float3 specularColor = saturate((_RMA_var.g+_Metallic_var));
                float specularMonochrome;
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float4 _ColorShift_var = UNITY_ACCESS_INSTANCED_PROP( Props, _ColorShift );
                float3 node_6343 = (_MainTex_var.rgb*_ColorShift_var.rgb);
                float _AOAmount_var = UNITY_ACCESS_INSTANCED_PROP( Props, _AOAmount );
                float3 diffuseColor = saturate(lerp(node_6343,(node_6343*_RMA_var.b),_AOAmount_var)); // Need this for specular when using metallic
...
////// Emissive:
                ...
                float3 emissive = (_RMA_var.a*_EmissiveColor_var.rgb*_EmissiveStrength_var);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _EmissiveColor_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EmissiveColor );
                float _EmissiveStrength_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EmissiveStrength );
                o.Emission = (_RMA_var.a*_EmissiveColor_var.rgb*_EmissiveStrength_var);
                
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float4 _ColorShift_var = UNITY_ACCESS_INSTANCED_PROP( Props, _ColorShift );
                float3 node_6343 = (_MainTex_var.rgb*_ColorShift_var.rgb);
                float _AOAmount_var = UNITY_ACCESS_INSTANCED_PROP( Props, _AOAmount );
                float3 diffColor = saturate(lerp(node_6343,(node_6343*_RMA_var.b),_AOAmount_var));
                float specularMonochrome;
                float3 specColor;
                float _Metallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Metallic );
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, saturate((_RMA_var.g+_Metallic_var)), specColor, specularMonochrome );
                float _MacroNoiseLerpLight_var = UNITY_ACCESS_INSTANCED_PROP( Props, _MacroNoiseLerpLight );
                float _MacroNoiseLerpDark_var = UNITY_ACCESS_INSTANCED_PROP( Props, _MacroNoiseLerpDark );
                float3 node_4418 = pow(abs(i.normalDir),2.0);
                float _RoughnessMacroScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _RoughnessMacroScale );
                ...
                float _BaseRoughnessLerpLight_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseRoughnessLerpLight );
                float _BaseRoughnessLerpDark_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseRoughnessLerpDark );
                float roughness = saturate(saturate(( lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r) > 0.5 ? (1.0-(1.0-2.0*(lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r)-0.5))*(1.0-lerp(_MacroNoiseLerpLight_var,_MacroNoiseLerpDark_var,(node_4418.r*_node_7181.r + node_4418.g*_node_217.r + node_4418.b*_node_4734.r)))) : (2.0*lerp(_BaseRoughnessLerpLight_var,_BaseRoughnessLerpDark_var,_RMA_var.r)*lerp(_MacroNoiseLerpLight_var,_MacroNoiseLerpDark_var,(node_4418.r*_node_7181.r + node_4418.g*_node_217.r + node_4418.b*_node_4734.r))) )));
