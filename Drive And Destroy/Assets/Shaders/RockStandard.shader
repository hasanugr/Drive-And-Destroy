...
Shader "Shader Forge/RockStandard" {
    Properties {
        ...
        _AOAmount ("AO Amount", Range(0, 5)) = 3.043478
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
